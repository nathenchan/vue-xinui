...
<x-dialog :visible.sync="dialogVisible" :dialogStyle="{width:'30%',height:'50%',borderRadius:'10px'}" :show-close="true" :mask-click-close="false" title="弹窗标题">
...
<x-dialog :visible.sync="dialogVisible2" :dialogStyle="{width:'20%',height:'200px',top:'-100px',borderRadius:'10px'}" :show-close="true" :mask-click-close="false" title="取消与确认">
	<div class="my-dialog-content">
		<p>是否删除</p>
